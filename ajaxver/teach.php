...
<body>
	...
	<div class="container">
		<div class="row"><!--logo 4個欄位-->
            ...
            <div class="col-md-8 col_border" style="margin:0px auto;">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="collapse navbar-collapse bs-example-js-navbar-collapse">
                            <ul class="nav navbar-nav">
                                <li class="dropdown">
                                    <a id="drop1" href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"> Dropdown <span class="caret"></span> </a>
                                ...
                                <li class="dropdown">
                                    <a id="drop2" href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"> Dropdown <span class="caret"></span> </a>
        ...
        <a href="video.html">影片教材</a><br/>
        <a href="tea.html">茶葉辨識</a>
        </div>
